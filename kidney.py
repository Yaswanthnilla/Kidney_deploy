...
def predict3():
    ...
    if output==1:
         return render_template("result.html",prediction_text="Your are having high chances of getting kidney disease")
    else:
        return render_template("result.html",prediction_text="No Need to Worry, You are safe!")
